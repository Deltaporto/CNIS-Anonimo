...
// ⚡ Bolt: Fast Uint8Array to string conversion using chunked String.fromCharCode.apply.
// Avoids Array.from(...).join('') which is extremely slow on V8 for large arrays.
