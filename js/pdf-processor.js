...
// ⚡ Bolt: Fast conversion of Uint8Array to string, avoiding maximum call stack size exceeded errors
// and significantly outperforming Array.from() with String.fromCharCode map.
...
async function _substituirViaBytesRaw(pdfBytes, specs, specsHex = []) {
  ...
  // ⚡ Bolt: Use fast bytesToString instead of Array.from + String.fromCharCode map
  ...
  while ((match = regexStreams.exec(bin)) !== null) {
    // ⚡ Bolt: Use encodeLatin1 instead of Uint8Array.from + String.prototype.split + map
