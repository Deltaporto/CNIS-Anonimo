...
function _sobrepoeRangeProtegido(match, ranges) {
  ...
  // ⚡ Bolt: Fast-path optimization. Replacing .some() with a standard for loop avoids callback allocation overhead in a hot path, yielding significant speedups in V8.
